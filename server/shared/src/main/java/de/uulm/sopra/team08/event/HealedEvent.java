...
/**
 * Healed INGAME Event, sent when a character is healed (e.g. by Stan Lee).
 */
public class HealedEvent extends MMIngameEvent {
    ...
    /**
     * Creates a new Healed INGAME Event
     *
     ...
     */
    public HealedEvent(@NotNull Tuple<EntityID, Integer> targetEntity, @NotNull Tuple<Integer, Integer> targetField, int amount) {
        super(EventType.HEALED);
    ...
    /**
     * Convenience method to get a {@link HealedEvent} from a {@link JsonObject}
     *
     * @param json {@link JsonObject} to be transformed
     * @return the parsed {@link HealedEvent}
     * @throws IllegalArgumentException if {@link HealedEvent} could not be parsed from the {@link JsonObject}
     */
    public static HealedEvent fromJson(JsonObject json) {
        try {
            ...
            return new HealedEvent(targetEntityTuple, targetFieldTuple, amount);
    ...
    /**
     * Convenience method for transforming a {@link HealedEvent} into a JSON String
     *
     * @return {@link HealedEvent} as JSON String
     */
    @Override
    public String toJsonEvent() {
        // create JSON Object
        JsonObject healedEvent = new JsonObject();

        // add JSON properties
        healedEvent.addProperty("eventType", "HealedEvent");
        healedEvent.add("targetEntity", gson.toJsonTree(targetEntity));
        healedEvent.add("targetField", Tuple.toJsonArray(targetField));
        healedEvent.addProperty("amount", amount);

        // return JSON as String
        return gson.toJson(healedEvent);
    }
    ...
    public boolean equals(Object o) {
        ...
        HealedEvent that = (HealedEvent) o;
