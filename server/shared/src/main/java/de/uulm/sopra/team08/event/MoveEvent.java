...
/**
 * Move INGAME Event, sent everytime a character moves.
 */
public class MoveEvent extends MMIngameEvent {
    ...
    /**
     * Creates a new Move INGAME Event
     *
     ...
     */
    public MoveEvent(@NotNull Tuple<EntityID, Integer> originEntity, @NotNull Tuple<Integer, Integer> originField, @NotNull Tuple<Integer, Integer> targetField) {
    ...
    /**
     * Convenience method to get a {@link MoveEvent} from a {@link JsonObject}
     *
     * @param json {@link JsonObject} to be transformed
     * @return the parsed {@link MoveEvent}
     * @throws IllegalArgumentException if {@link MoveEvent} could not be parsed from the {@link JsonObject}
     */
    public static MoveEvent fromJson(JsonObject json) {
        try {
            ...
            return new MoveEvent(originEntityTuple, originFieldTuple, targetFieldTuple);
    ...
    /**
     * Convenience method for transforming a {@link MoveEvent} into a JSON String
     *
     * @return {@link MoveEvent} as JSON String
     */
    @Override
    public String toJsonEvent() {
        ...
        // add JSON properties
        moveEvent.addProperty("eventType", "MoveEvent");
    ...
    public boolean equals(Object o) {
        ...
        if (!getOriginEntity().equals(moveEvent.getOriginEntity())) return false;
        if (!getOriginField().equals(moveEvent.getOriginField())) return false;
        return getTargetField().equals(moveEvent.getTargetField());
    }
