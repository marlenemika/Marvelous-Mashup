...
/**
 * UseInfinityStone INGAME Event, sent when a character uses any InfinityStone
 */
public class UseInfinityStoneEvent extends MMIngameEvent {
    ...
    /**
     * Creates a new UseInfinityStone INGAME Event
     *
     ...
     */
    public UseInfinityStoneEvent(@NotNull Tuple<EntityID, Integer> originEntity, @NotNull Tuple<EntityID, Integer> targetEntity, @NotNull Tuple<Integer, Integer> originField, @NotNull Tuple<Integer, Integer> targetField, @NotNull Tuple<EntityID, Integer> stoneType) throws IllegalArgumentException {
        super(EventType.USE_INFINITY_STONE);
    ...
    /**
     * Convenience method to get a {@link UseInfinityStoneEvent} from a {@link JsonObject}
     *
     * @param json {@link JsonObject} to be transformed
     * @return the parsed {@link UseInfinityStoneEvent}
     * @throws IllegalArgumentException if {@link UseInfinityStoneEvent} could not be parsed from the {@link JsonObject}
     */
    public static UseInfinityStoneEvent fromJson(JsonObject json) {
        try {
            ...
            return new UseInfinityStoneEvent(originEntityTuple, targetEntityTuple, originFieldTuple, targetFieldTuple, stoneTypeTuple);
    ...
    /**
     * Convenience method for transforming a {@link UseInfinityStoneEvent} into a JSON String
     *
     * @return {@link UseInfinityStoneEvent} as JSON String
     */
    @Override
    public String toJsonEvent() {
        ...
        // add JSON properties
        useInfinityStoneEvent.addProperty("eventType", "UseInfinityStoneEvent");
        useInfinityStoneEvent.add("originEntity", gson.toJsonTree(originEntity));
        useInfinityStoneEvent.add("targetEntity", gson.toJsonTree(targetEntity));
    ...
    public boolean equals(Object o) {
        ...
        UseInfinityStoneEvent that = (UseInfinityStoneEvent) o;
